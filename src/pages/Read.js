  ...
  return (
    <div className='container  my-5 col-12 col-lg-6 col-sm-8 col-md-8 p-3' style={{}}>
      <table className='table table-bordered  '>
        <tr className='bg-warning  col-lg-fs-5 justify-content-between' style={{ padding: "50px", }}>
          ...
          return (
            <>
              <tr className='bg-info text-dark fs-5' >
                ...
                <td  > <button className='fs-4 text-danger' style={{ border: "none", }} onClick={() => deleterecord(data.id)}><MdDelete /></button><ToastContainer /> </td>
              </tr>
            </>
          );
